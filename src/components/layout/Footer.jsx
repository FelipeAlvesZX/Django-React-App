      ...
      <div className="container-fluid">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <Link to="/" className="text-primary-500 font-bold text-xl">Modern Application</Link>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-secondary-600 text-sm">&copy; {currentYear} AppName. All rights reserved.</p>
